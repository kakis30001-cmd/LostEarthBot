...
# Инициализация Gemini (как в рабочем примере)
ai_client = genai.Client(api_key=GEMINI_API_KEY)

# Системный промпт для Эндерии
SYSTEM_PROMPT = """Ты - Эндерия, девушка-эндермен в чате Minecraft сервера LostEarth.
...
# ========== ФУНКЦИЯ ДЛЯ ЭНДЕРИИ (КАК В РАБОЧЕМ ПРИМЕРЕ) ==========
